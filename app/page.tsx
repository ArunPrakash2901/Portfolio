...
export default async function Home() {
  ...
  try {
    ...
    radarData = JSON.parse(fs.readFileSync(scoresPath, 'utf8')) as RadarDatum[];
  } catch (error) {
  ...
  const tickerItems = [
    { label: "Now reading", value: "Clinical ML Explainability" },
    { label: "Working on", value: "Geospatial Electorate Maps" },
    { label: "Learning", value: "Bayesian VAR Modeling" },
    { label: "Exploring", value: "Macro Nowcasting" },
          ...
          <div className="flex flex-col border-t-[0.5px] border-[#D4C9B8]">
             {writingPosts.length > 0 ? writingPosts.map(post => (
               ...
               <div className="py-4 text-[#556E74] text-[12px] italic border-b-[0.5px] border-[#D4C9B8]">
                 No publishing history detected. Add raw `.mdx` files to `/content/projects` marked as &ldquo;Writing&rdquo;. 
               </div>
             )}
          </div>
        </section>
